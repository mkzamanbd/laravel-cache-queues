        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <table class="w-full">
                    <thead>
                        <tr>
                            <th class="px-2 py-2 border-b-2 border-gray-200 bg-gray-100 font-semibold text-gray-600 uppercase tracking-wider" style="text-align: left">
                                <span>SL</span>
                            </th>
                            <th class="px-2 py-2 border-b-2 border-gray-200 bg-gray-100 text-xs font-semibold text-gray-600 uppercase tracking-wider" style="text-align: left">
                                <span>Name</span>
                            </th>
                            <th class="px-2 py-2 border-b-2 border-gray-200 bg-gray-100 text-xs font-semibold text-gray-600 uppercase tracking-wider" style="text-align: left">
                                Email
                        ...
                        @foreach ($users as $user)
                            <tr>
                                <td class="px-2 py-2 border-b border-gray-200 bg-white text-sm">
                                    <span>{{ $loop->index + $users->firstItem() }}.</span>
                                </td>
                                <td class="px-2 py-2 border-b border-gray-200 bg-white text-sm">
